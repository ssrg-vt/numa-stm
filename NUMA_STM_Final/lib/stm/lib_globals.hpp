...
namespace stm
{
  ...
  extern pad_word_t group_tokens[MAX_THREADS];
  extern pad_word_t in_group_flags[MAX_THREADS];
  extern pad_word_t group_is_aborting[MAX_THREADS];
  extern volatile int server_dec[MAX_THREADS];
}
