...
// Global Parameter
/******************************************/
extern volatile uint64_t CLOCK_DIFF;
...
#define ABORT_RW    (0x10)
#define ABORT_WW    (0x20)
#define RC_MASK     (0xf)

#define encode_abrt_type(t) (RC((Abort) | (RC)(t)))
#define decode_abrt_type(x) (((x) >> 4) << 4)
#define get_rc(x) ((x) & RC_MASK)
