...
do
	...
	temp=$(echo "$(/home/users/mohamed2/nemo/kmeans/kmeans -m15 -n15 -t0.00001 -i /home/users/mohamed2/nemo/kmean/inputs/random-n65536-d32-c16.txt -p$i)" | egrep -e 'Time: [^ ]*' -o | cut -d ' ' -f 2)
...
do
	...
	echo $i $part_time >> "kmeansLow.csv"
...
do	
	...
	echo $i $part_time >> "labyrinth.csv"
...
do
	...
	echo $i $part_time  >> "vacationHi.csv"
...
do
	...
	echo $i $part_time  >> "vacationLow.csv"
...
do
	...
	temp=$(echo "$(/home/users/mohamed2/nemo/bayes/bayes -v32 -r4096 -n10 -p40 -i2 -e8 -s1 -t$i)" | egrep -e 'Learn time[ ]*=' | egrep -e [1234567890.]* -o)
	part_time=$(echo $part_time $temp | awk ' { printf "%f\n", $1 + $2 } ') 
