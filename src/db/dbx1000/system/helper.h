...
#define PAUSE { __asm__ ( "pause":::"memory" ); }
...
// malloc helper
/************************************************/
// In order to avoid false sharing, any unshared read/write array residing on
// the same cache line should be modified to be read only array with pointers
// to thread local data block.
